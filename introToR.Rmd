...
- The link below will show you how to automatically download datasets from dropbox. 
...
If your dataset (csv file) is in your local folder. 
 ...
 - header argument tells R that the first row are the column names
...
<br>
<center>**Once you finish the questions, give yourself a pad in the back and look forward to the workshop!** </center>
<br>
