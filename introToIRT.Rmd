...
ggplot(l.format, aes(Theta, P.1)) + 
  ...
  annotate(geom="text", label=0.2, x=-4, y=0.2, vjust=-1, size=4) +
  theme_bw() + 
  theme(text = element_text(size=16),
        axis.text.x=element_text(colour="black"),
        axis.text.y=element_text(colour="black"),
...
ggplot(l.format, aes(Theta, P.1)) + 
  ...
  annotate(geom="text", label=0.8, x=-4, y=0.8, vjust=-1, size=4)  +theme_bw() + 
  theme(text = element_text(size=16),
        axis.text.x=element_text(colour="black"),
        axis.text.y=element_text(colour="black"),
        legend.title=element_blank())
...
For e.g. if we have 4 items with 7 response options. Then the distinct variances and covariances is:<br/> 

<center> $\frac{4(4+1)}{2} = 10$ parameters. </center> <br/>

The number of estimated parameters is:<br/>
