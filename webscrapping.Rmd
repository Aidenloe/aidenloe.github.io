...
## **Scrape data by years based on URL**
...
## **Scrape content off websites (Wiki)**
...
## **Scrape content off website (BBC)**
...
## This involves some non trivial data cleaning
...
# Notice that the population estimate has lots of commas in (e.g. "4,863,300"). We need to remove them so that R can treat it as a number.
mydata[,"Population estimate, July 1, 2016[4]"] = gsub(",", "", mydata[,"Population estimate, July 1, 2016[4]"]) #this removes all commas
