...
**What happens if you are interested in differences between factor scores instead?**

```{r boxplot factor scores}
...
*One thing to note is: if two boxes' notches do not overlap this is ‘strong evidence’ their medians differ (Chambers et al., 1983, p. 62).**
