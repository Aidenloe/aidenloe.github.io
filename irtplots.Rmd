...
## **ICCs by difficulty level plots**
...
So I asked for help around and came up with the code. 
...
## **ICC polytomous item plot**

The code below will let you to either plot one polytomous item at a time or plot all the items together. 

It is rather messy to plot all the items together. I would recommend each item to have its own separate plot. 

You will need `mirt` and `tidyr` packages to run this demo.
